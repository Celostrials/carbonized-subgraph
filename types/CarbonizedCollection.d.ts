...
interface CarbonizedCollectionInterface extends ethers.utils.Interface {
  ...
  events: {
    ...
    "CarbonizedToken(uint256,uint256)": EventFragment;
    "DecarbonizedToken(uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "CarbonizedToken"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "DecarbonizedToken"): EventFragment;
...
export type CarbonizedTokenEvent = TypedEvent<
  [BigNumber, BigNumber] & { tokenId: BigNumber; amount: BigNumber }
>;

export type DecarbonizedTokenEvent = TypedEvent<
...
export class CarbonizedCollection extends BaseContract {
  ...
  filters: {
    ...
    "CarbonizedToken(uint256,uint256)"(
      tokenId?: null,
      amount?: null
    ): TypedEventFilter<
      [BigNumber, BigNumber],
